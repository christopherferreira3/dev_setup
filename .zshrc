export ANDROID_HOME=/Users/Shared/Jenkins/Home/tools/android-sdk
export PATH=${PATH}:$ANDROID_HOME/tools:$ANDROID_HOME/platform-tools

#export all_proxy="https://localost:9050/"
#export all_proxy="http://localost:9050/"

# If you come from bash you might have to change your $PATH.
# export PATH=$HOME/bin:/usr/local/bin:$PATH

alias gettcpusage="lsof -i -n -P | grep TCP"

alias buildapp="python3 setup.py sdist bdist_wheel"

alias ll="ls -lt"

alias creditcard="adb shell input text 5101180000000007"

# alias for a timer
alias timer="bash ~/timer.sh"

# cd BDS Wallet
alias bdswallet='cd ~/pCloud\ Drive/Account\ shares/AppCoins/appcoins_wallet'

# connect ssh
alias sshaptoide='ssh aptoide@192.168.1.26'
